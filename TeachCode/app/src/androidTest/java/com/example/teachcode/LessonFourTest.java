...
@LargeTest
public class LessonFourTest {

    @Rule
    public ActivityTestRule<LessonFour> mActivityRule = new ActivityTestRule<>(LessonFour.class);
    ...
    @Test
    public void test4() {
        Espresso.onView(withId(R.id.editText1)).perform(typeText("Samsung"));
        Espresso.onView(withId(R.id.editText1)).perform(closeSoftKeyboard());
        Espresso.onView(withId(R.id.btnSub)).perform(click());
