...
public class LessonTwoTest {
    ...
    @Rule
    public ActivityTestRule<LessonTwo> mActivityRule = new ActivityTestRule<>(LessonTwo.class);
    ...
    @Test
    public void test4() {
        Espresso.onView(withId(R.id.editText1)).perform(typeText("int sum = 10 + 5;"));
        Espresso.onView(withId(R.id.editText1)).perform(closeSoftKeyboard());
        Espresso.onView(withId(R.id.btnSub)).perform(click());
